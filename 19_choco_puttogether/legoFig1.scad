...
// testing
//scale([1.5, 1.5, 1.5])
//legoHead(loc_res = 128, show_origin = 0);
/*minkowski() {
    legoHead(loc_res = 16, show_origin = 0, show_face = 0);
    sphere(d = 1.3, $fn = 20);
}*/

//scale([1.5, 1.5, 1.5])
//legoBody(loc_res = 128, show_origin = 0);
/*minkowski() {
    legoBody(loc_res = 16, show_origin = 0);
    sphere(d = 1.3, $fn = 16);
}*/
...
rotate([0, 0, 0])
mirror([0, 0, 0])
//legoArmsWide(128, show_origin = 2, 1, 0);
minkowski() {
    legoArmsWide(16, show_origin = 0, 1, 0);
    sphere(d = 2, $fn = 16);
}*/
